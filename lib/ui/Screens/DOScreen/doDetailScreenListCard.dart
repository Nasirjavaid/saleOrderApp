...
class DODetailScreenListCard extends StatelessWidget {
  //Items items;

  DODetailScreenListCard({
    Key key,
    // this.items,
  }) : super(key: key);
  @override
                        ...
                        child: Row(
                          children: <Widget>[
                            Padding(
                              ...
                              child: Icon(Icons.ac_unit,size: 20,color: AppTheme.appBackgroundColorforCard3,),
                            ),
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text("Acitic Acid SKP-MT",
                                  style: TextStyle(
